...
//   const { currentPlayer, setCurrentPlayer, currentPlayerIndex, setCurrentPlayerIndex } = usePlayerStore();
...
//           return (
//            <TouchableOpacity onPress={() => router.push(`../screens/${index}`)} key={index}>
//               <MusicListItem
//                 key={index}
//                 title={music.title}
